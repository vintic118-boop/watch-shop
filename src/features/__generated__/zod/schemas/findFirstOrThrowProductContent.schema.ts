...
export const ProductContentFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ProductContentSelect> = z.object({
...
export const ProductContentFindFirstOrThrowSelectZodSchema = z.object({
    productId: z.boolean().optional(),
    titleSnapshot: z.boolean().optional(),
    brandSnapshot: z.boolean().optional(),
    refSnapshot: z.boolean().optional(),
...
export const ProductContentFindFirstOrThrowSchema: z.ZodType<Prisma.ProductContentFindFirstOrThrowArgs> = z.object({ select: ProductContentFindFirstOrThrowSelectSchema.optional(), include: ProductContentIncludeObjectSchema.optional(), orderBy: z.union([ProductContentOrderByWithRelationInputObjectSchema, ProductContentOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductContentWhereInputObjectSchema.optional(), cursor: ProductContentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductContentScalarFieldEnumSchema, ProductContentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProductContentFindFirstOrThrowArgs>;

export const ProductContentFindFirstOrThrowZodSchema = z.object({ select: ProductContentFindFirstOrThrowSelectSchema.optional(), include: ProductContentIncludeObjectSchema.optional(), orderBy: z.union([ProductContentOrderByWithRelationInputObjectSchema, ProductContentOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductContentWhereInputObjectSchema.optional(), cursor: ProductContentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductContentScalarFieldEnumSchema, ProductContentScalarFieldEnumSchema.array()]).optional() }).strict();