...
export const MechanicalPartCatalogFindFirstOrThrowSelectSchema: z.ZodType<Prisma.MechanicalPartCatalogSelect> = z.object({
...
export const MechanicalPartCatalogFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    name: z.boolean().optional(),
    group: z.boolean().optional(),
...
export const MechanicalPartCatalogFindFirstOrThrowSchema: z.ZodType<Prisma.MechanicalPartCatalogFindFirstOrThrowArgs> = z.object({ select: MechanicalPartCatalogFindFirstOrThrowSelectSchema.optional(), include: MechanicalPartCatalogIncludeObjectSchema.optional(), orderBy: z.union([MechanicalPartCatalogOrderByWithRelationInputObjectSchema, MechanicalPartCatalogOrderByWithRelationInputObjectSchema.array()]).optional(), where: MechanicalPartCatalogWhereInputObjectSchema.optional(), cursor: MechanicalPartCatalogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MechanicalPartCatalogScalarFieldEnumSchema, MechanicalPartCatalogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MechanicalPartCatalogFindFirstOrThrowArgs>;

export const MechanicalPartCatalogFindFirstOrThrowZodSchema = z.object({ select: MechanicalPartCatalogFindFirstOrThrowSelectSchema.optional(), include: MechanicalPartCatalogIncludeObjectSchema.optional(), orderBy: z.union([MechanicalPartCatalogOrderByWithRelationInputObjectSchema, MechanicalPartCatalogOrderByWithRelationInputObjectSchema.array()]).optional(), where: MechanicalPartCatalogWhereInputObjectSchema.optional(), cursor: MechanicalPartCatalogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MechanicalPartCatalogScalarFieldEnumSchema, MechanicalPartCatalogScalarFieldEnumSchema.array()]).optional() }).strict();