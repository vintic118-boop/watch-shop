...
export const system_job_run_logFindFirstOrThrowSelectSchema: z.ZodType<Prisma.system_job_run_logSelect> = z.object({
...
export const system_job_run_logFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    processor_key: z.boolean().optional(),
    trigger_source: z.boolean().optional(),
    status: z.boolean().optional(),
...
export const system_job_run_logFindFirstOrThrowSchema: z.ZodType<Prisma.system_job_run_logFindFirstOrThrowArgs> = z.object({ select: system_job_run_logFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([system_job_run_logOrderByWithRelationInputObjectSchema, system_job_run_logOrderByWithRelationInputObjectSchema.array()]).optional(), where: system_job_run_logWhereInputObjectSchema.optional(), cursor: system_job_run_logWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SystemJobRunLogScalarFieldEnumSchema, SystemJobRunLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.system_job_run_logFindFirstOrThrowArgs>;

export const system_job_run_logFindFirstOrThrowZodSchema = z.object({ select: system_job_run_logFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([system_job_run_logOrderByWithRelationInputObjectSchema, system_job_run_logOrderByWithRelationInputObjectSchema.array()]).optional(), where: system_job_run_logWhereInputObjectSchema.optional(), cursor: system_job_run_logWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SystemJobRunLogScalarFieldEnumSchema, SystemJobRunLogScalarFieldEnumSchema.array()]).optional() }).strict();