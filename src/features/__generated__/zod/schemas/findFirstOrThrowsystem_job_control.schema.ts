...
export const system_job_controlFindFirstOrThrowSelectSchema: z.ZodType<Prisma.system_job_controlSelect> = z.object({
...
export const system_job_controlFindFirstOrThrowSelectZodSchema = z.object({
    key: z.boolean().optional(),
    label: z.boolean().optional(),
    enabled: z.boolean().optional(),
    batch_size: z.boolean().optional(),
...
export const system_job_controlFindFirstOrThrowSchema: z.ZodType<Prisma.system_job_controlFindFirstOrThrowArgs> = z.object({ select: system_job_controlFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([system_job_controlOrderByWithRelationInputObjectSchema, system_job_controlOrderByWithRelationInputObjectSchema.array()]).optional(), where: system_job_controlWhereInputObjectSchema.optional(), cursor: system_job_controlWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SystemJobControlScalarFieldEnumSchema, SystemJobControlScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.system_job_controlFindFirstOrThrowArgs>;

export const system_job_controlFindFirstOrThrowZodSchema = z.object({ select: system_job_controlFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([system_job_controlOrderByWithRelationInputObjectSchema, system_job_controlOrderByWithRelationInputObjectSchema.array()]).optional(), where: system_job_controlWhereInputObjectSchema.optional(), cursor: system_job_controlWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SystemJobControlScalarFieldEnumSchema, SystemJobControlScalarFieldEnumSchema.array()]).optional() }).strict();