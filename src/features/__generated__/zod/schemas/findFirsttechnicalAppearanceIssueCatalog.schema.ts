...
export const technicalAppearanceIssueCatalogFindFirstSelectSchema: z.ZodType<Prisma.technicalAppearanceIssueCatalogSelect> = z.object({
...
export const technicalAppearanceIssueCatalogFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    area: z.boolean().optional(),
    label: z.boolean().optional(),
...
export const technicalAppearanceIssueCatalogFindFirstSchema: z.ZodType<Prisma.technicalAppearanceIssueCatalogFindFirstArgs> = z.object({ select: technicalAppearanceIssueCatalogFindFirstSelectSchema.optional(),  orderBy: z.union([technicalAppearanceIssueCatalogOrderByWithRelationInputObjectSchema, technicalAppearanceIssueCatalogOrderByWithRelationInputObjectSchema.array()]).optional(), where: technicalAppearanceIssueCatalogWhereInputObjectSchema.optional(), cursor: technicalAppearanceIssueCatalogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TechnicalAppearanceIssueCatalogScalarFieldEnumSchema, TechnicalAppearanceIssueCatalogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.technicalAppearanceIssueCatalogFindFirstArgs>;

export const technicalAppearanceIssueCatalogFindFirstZodSchema = z.object({ select: technicalAppearanceIssueCatalogFindFirstSelectSchema.optional(),  orderBy: z.union([technicalAppearanceIssueCatalogOrderByWithRelationInputObjectSchema, technicalAppearanceIssueCatalogOrderByWithRelationInputObjectSchema.array()]).optional(), where: technicalAppearanceIssueCatalogWhereInputObjectSchema.optional(), cursor: technicalAppearanceIssueCatalogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TechnicalAppearanceIssueCatalogScalarFieldEnumSchema, TechnicalAppearanceIssueCatalogScalarFieldEnumSchema.array()]).optional() }).strict();