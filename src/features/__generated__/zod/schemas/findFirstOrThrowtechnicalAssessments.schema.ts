...
export const technicalAssessmentsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.technicalAssessmentsSelect> = z.object({
...
export const technicalAssessmentsFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    serviceRequestId: z.boolean().optional(),
    machineType: z.boolean().optional(),
    movementStatus: z.boolean().optional(),
...
export const technicalAssessmentsFindFirstOrThrowSchema: z.ZodType<Prisma.technicalAssessmentsFindFirstOrThrowArgs> = z.object({ select: technicalAssessmentsFindFirstOrThrowSelectSchema.optional(), include: technicalAssessmentsIncludeObjectSchema.optional(), orderBy: z.union([technicalAssessmentsOrderByWithRelationInputObjectSchema, technicalAssessmentsOrderByWithRelationInputObjectSchema.array()]).optional(), where: technicalAssessmentsWhereInputObjectSchema.optional(), cursor: technicalAssessmentsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TechnicalAssessmentsScalarFieldEnumSchema, TechnicalAssessmentsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.technicalAssessmentsFindFirstOrThrowArgs>;

export const technicalAssessmentsFindFirstOrThrowZodSchema = z.object({ select: technicalAssessmentsFindFirstOrThrowSelectSchema.optional(), include: technicalAssessmentsIncludeObjectSchema.optional(), orderBy: z.union([technicalAssessmentsOrderByWithRelationInputObjectSchema, technicalAssessmentsOrderByWithRelationInputObjectSchema.array()]).optional(), where: technicalAssessmentsWhereInputObjectSchema.optional(), cursor: technicalAssessmentsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TechnicalAssessmentsScalarFieldEnumSchema, TechnicalAssessmentsScalarFieldEnumSchema.array()]).optional() }).strict();