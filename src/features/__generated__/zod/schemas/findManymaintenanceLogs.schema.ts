...
export const maintenanceLogsFindManySelectSchema: z.ZodType<Prisma.maintenanceLogsSelect> = z.object({
...
export const maintenanceLogsFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    serviceRequestId: z.boolean().optional(),
    technicalAssessmentId: z.boolean().optional(),
    approvalRequestId: z.boolean().optional(),
