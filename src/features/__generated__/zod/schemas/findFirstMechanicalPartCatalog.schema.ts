...
export const MechanicalPartCatalogFindFirstSelectSchema: z.ZodType<Prisma.MechanicalPartCatalogSelect> = z.object({
...
export const MechanicalPartCatalogFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    name: z.boolean().optional(),
    group: z.boolean().optional(),
...
export const MechanicalPartCatalogFindFirstSchema: z.ZodType<Prisma.MechanicalPartCatalogFindFirstArgs> = z.object({ select: MechanicalPartCatalogFindFirstSelectSchema.optional(), include: MechanicalPartCatalogIncludeObjectSchema.optional(), orderBy: z.union([MechanicalPartCatalogOrderByWithRelationInputObjectSchema, MechanicalPartCatalogOrderByWithRelationInputObjectSchema.array()]).optional(), where: MechanicalPartCatalogWhereInputObjectSchema.optional(), cursor: MechanicalPartCatalogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MechanicalPartCatalogScalarFieldEnumSchema, MechanicalPartCatalogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MechanicalPartCatalogFindFirstArgs>;

export const MechanicalPartCatalogFindFirstZodSchema = z.object({ select: MechanicalPartCatalogFindFirstSelectSchema.optional(), include: MechanicalPartCatalogIncludeObjectSchema.optional(), orderBy: z.union([MechanicalPartCatalogOrderByWithRelationInputObjectSchema, MechanicalPartCatalogOrderByWithRelationInputObjectSchema.array()]).optional(), where: MechanicalPartCatalogWhereInputObjectSchema.optional(), cursor: MechanicalPartCatalogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MechanicalPartCatalogScalarFieldEnumSchema, MechanicalPartCatalogScalarFieldEnumSchema.array()]).optional() }).strict();