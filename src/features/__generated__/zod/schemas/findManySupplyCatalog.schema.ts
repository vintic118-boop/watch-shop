...
export const SupplyCatalogFindManySelectSchema: z.ZodType<Prisma.SupplyCatalogSelect> = z.object({
...
export const SupplyCatalogFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    name: z.boolean().optional(),
    category: z.boolean().optional(),
...
export const SupplyCatalogFindManySchema: z.ZodType<Prisma.SupplyCatalogFindManyArgs> = z.object({ select: SupplyCatalogFindManySelectSchema.optional(), include: SupplyCatalogIncludeObjectSchema.optional(), orderBy: z.union([SupplyCatalogOrderByWithRelationInputObjectSchema, SupplyCatalogOrderByWithRelationInputObjectSchema.array()]).optional(), where: SupplyCatalogWhereInputObjectSchema.optional(), cursor: SupplyCatalogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SupplyCatalogScalarFieldEnumSchema, SupplyCatalogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SupplyCatalogFindManyArgs>;

export const SupplyCatalogFindManyZodSchema = z.object({ select: SupplyCatalogFindManySelectSchema.optional(), include: SupplyCatalogIncludeObjectSchema.optional(), orderBy: z.union([SupplyCatalogOrderByWithRelationInputObjectSchema, SupplyCatalogOrderByWithRelationInputObjectSchema.array()]).optional(), where: SupplyCatalogWhereInputObjectSchema.optional(), cursor: SupplyCatalogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SupplyCatalogScalarFieldEnumSchema, SupplyCatalogScalarFieldEnumSchema.array()]).optional() }).strict();