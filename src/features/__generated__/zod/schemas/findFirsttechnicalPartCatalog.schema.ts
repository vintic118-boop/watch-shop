...
export const technicalPartCatalogFindFirstSelectSchema: z.ZodType<Prisma.technicalPartCatalogSelect> = z.object({
...
export const technicalPartCatalogFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    name: z.boolean().optional(),
    appliesTo: z.boolean().optional(),
...
export const technicalPartCatalogFindFirstSchema: z.ZodType<Prisma.technicalPartCatalogFindFirstArgs> = z.object({ select: technicalPartCatalogFindFirstSelectSchema.optional(),  orderBy: z.union([technicalPartCatalogOrderByWithRelationInputObjectSchema, technicalPartCatalogOrderByWithRelationInputObjectSchema.array()]).optional(), where: technicalPartCatalogWhereInputObjectSchema.optional(), cursor: technicalPartCatalogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TechnicalPartCatalogScalarFieldEnumSchema, TechnicalPartCatalogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.technicalPartCatalogFindFirstArgs>;

export const technicalPartCatalogFindFirstZodSchema = z.object({ select: technicalPartCatalogFindFirstSelectSchema.optional(),  orderBy: z.union([technicalPartCatalogOrderByWithRelationInputObjectSchema, technicalPartCatalogOrderByWithRelationInputObjectSchema.array()]).optional(), where: technicalPartCatalogWhereInputObjectSchema.optional(), cursor: technicalPartCatalogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TechnicalPartCatalogScalarFieldEnumSchema, TechnicalPartCatalogScalarFieldEnumSchema.array()]).optional() }).strict();