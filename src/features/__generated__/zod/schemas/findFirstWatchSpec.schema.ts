...
export const WatchSpecFindFirstSelectSchema: z.ZodType<Prisma.WatchSpecSelect> = z.object({
...
export const WatchSpecFindFirstSelectZodSchema = z.object({
    productId: z.boolean().optional(),
    model: z.boolean().optional(),
    year: z.boolean().optional(),
    caseType: z.boolean().optional(),
