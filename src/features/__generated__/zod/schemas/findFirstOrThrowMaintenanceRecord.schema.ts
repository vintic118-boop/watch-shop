...
export const MaintenanceRecordFindFirstOrThrowSelectSchema: z.ZodType<Prisma.MaintenanceRecordSelect> = z.object({
...
export const MaintenanceRecordFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    type: z.boolean().optional(),
    billable: z.boolean().optional(),
    serviceRequestId: z.boolean().optional(),
...
export const MaintenanceRecordFindFirstOrThrowSchema: z.ZodType<Prisma.MaintenanceRecordFindFirstOrThrowArgs> = z.object({ select: MaintenanceRecordFindFirstOrThrowSelectSchema.optional(), include: MaintenanceRecordIncludeObjectSchema.optional(), orderBy: z.union([MaintenanceRecordOrderByWithRelationInputObjectSchema, MaintenanceRecordOrderByWithRelationInputObjectSchema.array()]).optional(), where: MaintenanceRecordWhereInputObjectSchema.optional(), cursor: MaintenanceRecordWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MaintenanceRecordScalarFieldEnumSchema, MaintenanceRecordScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MaintenanceRecordFindFirstOrThrowArgs>;

export const MaintenanceRecordFindFirstOrThrowZodSchema = z.object({ select: MaintenanceRecordFindFirstOrThrowSelectSchema.optional(), include: MaintenanceRecordIncludeObjectSchema.optional(), orderBy: z.union([MaintenanceRecordOrderByWithRelationInputObjectSchema, MaintenanceRecordOrderByWithRelationInputObjectSchema.array()]).optional(), where: MaintenanceRecordWhereInputObjectSchema.optional(), cursor: MaintenanceRecordWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MaintenanceRecordScalarFieldEnumSchema, MaintenanceRecordScalarFieldEnumSchema.array()]).optional() }).strict();