...
export const TechnicalAssessmentFindManySelectSchema: z.ZodType<Prisma.TechnicalAssessmentSelect> = z.object({
...
export const TechnicalAssessmentFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    serviceRequestId: z.boolean().optional(),
    movementKind: z.boolean().optional(),
    preRate: z.boolean().optional(),
...
export const TechnicalAssessmentFindManySchema: z.ZodType<Prisma.TechnicalAssessmentFindManyArgs> = z.object({ select: TechnicalAssessmentFindManySelectSchema.optional(), include: TechnicalAssessmentIncludeObjectSchema.optional(), orderBy: z.union([TechnicalAssessmentOrderByWithRelationInputObjectSchema, TechnicalAssessmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: TechnicalAssessmentWhereInputObjectSchema.optional(), cursor: TechnicalAssessmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TechnicalAssessmentScalarFieldEnumSchema, TechnicalAssessmentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TechnicalAssessmentFindManyArgs>;

export const TechnicalAssessmentFindManyZodSchema = z.object({ select: TechnicalAssessmentFindManySelectSchema.optional(), include: TechnicalAssessmentIncludeObjectSchema.optional(), orderBy: z.union([TechnicalAssessmentOrderByWithRelationInputObjectSchema, TechnicalAssessmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: TechnicalAssessmentWhereInputObjectSchema.optional(), cursor: TechnicalAssessmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TechnicalAssessmentScalarFieldEnumSchema, TechnicalAssessmentScalarFieldEnumSchema.array()]).optional() }).strict();