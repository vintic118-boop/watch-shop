...
export const TechnicalAssessmentFindUniqueOrThrowSchema: z.ZodType<Prisma.TechnicalAssessmentFindUniqueOrThrowArgs> = z.object({ select: TechnicalAssessmentSelectObjectSchema.optional(), include: TechnicalAssessmentIncludeObjectSchema.optional(), where: TechnicalAssessmentWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.TechnicalAssessmentFindUniqueOrThrowArgs>;

export const TechnicalAssessmentFindUniqueOrThrowZodSchema = z.object({ select: TechnicalAssessmentSelectObjectSchema.optional(), include: TechnicalAssessmentIncludeObjectSchema.optional(), where: TechnicalAssessmentWhereUniqueInputObjectSchema }).strict();