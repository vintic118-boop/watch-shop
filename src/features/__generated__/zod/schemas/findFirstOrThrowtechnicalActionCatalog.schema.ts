...
export const technicalActionCatalogFindFirstOrThrowSelectSchema: z.ZodType<Prisma.technicalActionCatalogSelect> = z.object({
...
export const technicalActionCatalogFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    name: z.boolean().optional(),
    appliesTo: z.boolean().optional(),
