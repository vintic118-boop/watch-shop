...
export const ServiceRequestFindFirstSelectSchema: z.ZodType<Prisma.ServiceRequestSelect> = z.object({
...
export const ServiceRequestFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    type: z.boolean().optional(),
    billable: z.boolean().optional(),
    orderItemId: z.boolean().optional(),
