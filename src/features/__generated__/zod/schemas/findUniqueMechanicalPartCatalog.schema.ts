...
export const MechanicalPartCatalogFindUniqueSchema: z.ZodType<Prisma.MechanicalPartCatalogFindUniqueArgs> = z.object({ select: MechanicalPartCatalogSelectObjectSchema.optional(), include: MechanicalPartCatalogIncludeObjectSchema.optional(), where: MechanicalPartCatalogWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.MechanicalPartCatalogFindUniqueArgs>;

export const MechanicalPartCatalogFindUniqueZodSchema = z.object({ select: MechanicalPartCatalogSelectObjectSchema.optional(), include: MechanicalPartCatalogIncludeObjectSchema.optional(), where: MechanicalPartCatalogWhereUniqueInputObjectSchema }).strict();