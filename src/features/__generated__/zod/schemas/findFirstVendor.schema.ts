...
export const VendorFindFirstSelectSchema: z.ZodType<Prisma.VendorSelect> = z.object({
...
export const VendorFindFirstSchema: z.ZodType<Prisma.VendorFindFirstArgs> = z.object({ select: VendorFindFirstSelectSchema.optional(), include: VendorIncludeObjectSchema.optional(), orderBy: z.union([VendorOrderByWithRelationInputObjectSchema, VendorOrderByWithRelationInputObjectSchema.array()]).optional(), where: VendorWhereInputObjectSchema.optional(), cursor: VendorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VendorScalarFieldEnumSchema, VendorScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.VendorFindFirstArgs>;

export const VendorFindFirstZodSchema = z.object({ select: VendorFindFirstSelectSchema.optional(), include: VendorIncludeObjectSchema.optional(), orderBy: z.union([VendorOrderByWithRelationInputObjectSchema, VendorOrderByWithRelationInputObjectSchema.array()]).optional(), where: VendorWhereInputObjectSchema.optional(), cursor: VendorWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([VendorScalarFieldEnumSchema, VendorScalarFieldEnumSchema.array()]).optional() }).strict();