...
export const technicalAssessmentsFindManySelectSchema: z.ZodType<Prisma.technicalAssessmentsSelect> = z.object({
...
export const technicalAssessmentsFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    serviceRequestId: z.boolean().optional(),
    machineType: z.boolean().optional(),
    movementStatus: z.boolean().optional(),
...
export const technicalAssessmentsFindManySchema: z.ZodType<Prisma.technicalAssessmentsFindManyArgs> = z.object({ select: technicalAssessmentsFindManySelectSchema.optional(), include: technicalAssessmentsIncludeObjectSchema.optional(), orderBy: z.union([technicalAssessmentsOrderByWithRelationInputObjectSchema, technicalAssessmentsOrderByWithRelationInputObjectSchema.array()]).optional(), where: technicalAssessmentsWhereInputObjectSchema.optional(), cursor: technicalAssessmentsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TechnicalAssessmentsScalarFieldEnumSchema, TechnicalAssessmentsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.technicalAssessmentsFindManyArgs>;

export const technicalAssessmentsFindManyZodSchema = z.object({ select: technicalAssessmentsFindManySelectSchema.optional(), include: technicalAssessmentsIncludeObjectSchema.optional(), orderBy: z.union([technicalAssessmentsOrderByWithRelationInputObjectSchema, technicalAssessmentsOrderByWithRelationInputObjectSchema.array()]).optional(), where: technicalAssessmentsWhereInputObjectSchema.optional(), cursor: technicalAssessmentsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TechnicalAssessmentsScalarFieldEnumSchema, TechnicalAssessmentsScalarFieldEnumSchema.array()]).optional() }).strict();