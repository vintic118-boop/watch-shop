...
const supplycatalogwhereinputSchema = z.object({
  ...
  OR: z.lazy(() => SupplyCatalogWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => SupplyCatalogWhereInputObjectSchema), z.lazy(() => SupplyCatalogWhereInputObjectSchema).array()]).optional(),
